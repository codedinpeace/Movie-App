    ...
    <div className="min-h-screen bg-[#080808] flex items-center justify-center px-4 py-16">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="bg-[#111113] border border-white/[0.07] rounded-2xl p-8 shadow-[0_8px_40px_rgba(0,0,0,0.5)]">
          ...
          <p className="text-gray-500 text-sm mb-8">Sign in to continue watching on CineVibe.</p>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            ...
            <div className="flex flex-col gap-1.5">
              <div className="flex items-center justify-between">
                ...
                <span className="text-red-500 hover:text-red-400 text-xs cursor-pointer transition-colors">
                  Forgot password?
                </span>
              </div>
          ...
          <p className="text-center text-gray-500 text-sm">
            ...
            <Link to="/register" className="text-red-500 hover:text-red-400 font-medium no-underline transition-colors">
              Register
            </Link>
          </p>
