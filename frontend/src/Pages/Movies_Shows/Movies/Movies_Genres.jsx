...
const Movies_TopRated = () => {
  ...
  const { loading, topRatedMovies, getTopRatedMovies} = useMoviestore()
  const topRatedMoviesArr = topRatedMovies.slice(0, 10)
  ...
  const slideRight = () => {
    ...
    const maxPage = Math.ceil(topRatedMoviesArr.length / cardsPerPage) - 1
    ...
    <div className='px-6 md:px-12 lg:px-20'>
      <div className="popular-card">
        ...
        >
          ...
          {topRatedMoviesArr.map((popularMovie) => (
            <div
...
export default Movies_TopRated