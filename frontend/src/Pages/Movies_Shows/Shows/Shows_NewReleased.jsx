...
const Shows_NewReleased = () => {

  const { loading, popularShows, getPopularShows } = useMoviestore()
  const popularShowsArr = popularShows.slice(0, 10)
  ...
  const slideRight = () => {
    ...
    const maxPage = Math.ceil(popularShowsArr.length / cardsPerPage) - 1
    ...
    <div className='px-6 md:px-12 lg:px-20'>
      <div className="popular-card">
        ...
        >
          ...
          {popularShowsArr.map((popularMovie) => (
            <div
              key={popularMovie.id}
...
export default Shows_NewReleased